...
function renderDefaultSelector(id) {
    ReactDOM.render(<Selector
        options={[
            { fa: "trophy", name: "Leaderboard", entry: <LeaderboardView mountTo={picks} /> },
            { fa: "users", name: "Team Picks", entry: <PicksView mountTo={picks} /> },
            { fa: "microphone", name: "Host Picks", entry: <PicksView mountTo={host_picks} /> },
